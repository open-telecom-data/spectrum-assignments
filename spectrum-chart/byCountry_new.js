                    ...
                    d3.csv('csv/shareHolding_sql.csv', function(error, shareData) {
                        ...
                        d3.csv('csv/country.csv', function(error, countryData) {
                            ...
                            d3.csv('csv/freqBands_sql.csv', function(error, bandData) {
                                ...
                                var LicenseCountryJoin_tmp = join(OperatorCountryJoin, licData,"ID", "Operator_ID", function (lic, op) {
                                    return {
                                        ID:  lic.ID ,
                                ...
                                var operatorJoin = join(OperatorCountryJoin, licenseJoin, "ID", "Operator_ID", function (licJ, op) {
                                    return {
